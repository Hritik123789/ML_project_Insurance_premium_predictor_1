...
def predict(input_dict):
    # so here we need to create a func that has all the columns present in the ipynb file 
    # and it should also include all the label adn one hot encoded columns
